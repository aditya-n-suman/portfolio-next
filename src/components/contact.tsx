...
const Contact = () => {
	return (
		<section
			id="contact"
			className="flex flex-col items-center h-screen lg:w-3/5 mx-auto">
			<div className=" flex-1 flex flex-col items-center justify-center">
				...
				<button className="flex items-center text-green border-green border-1px rounded-1.5 px-6 py-3 fz-transition hover:fz-shadow hover:fz-translate">
					Say Hello
				</button>
			</div>
